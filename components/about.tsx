...
const About = () => {
  return (
    <motion.div className='flex flex-col mx-auto justify-center mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 p-6'
