...
const About = () => {
  return (
    <div className='flex flex-col mx-auto justify-center mb-28 max-w-[45rem] text-center leading-8 sm:mb-40 p-6'>
        <h1 className='text-3xl font-medium capitalize'>About me</h1>

        <p className='mb-3'>After successfully completing my Diploma in Nautical Science from Myanmar Mercantile Marine College, I decided to pursue my passion for programming. I studied full-stack web development from online courses on platforms like Udemy and Coursera. My favorite part of programming is the problem-solving aspect. I love the feeling of finally figuring out a solution to a problem. My core stack includes React, Next.js, Node.js, MySQL, and MongoDB and other utility libraries. Although I learned PHP and Laravel, I haven&apos;t dedicated as much time to them. I'm currently looking for a full-time position as a software developer.</p>
        <p>
